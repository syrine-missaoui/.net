...
namespace AM.Core.Domain
{
    public class Passenger
    {
        ...
        [DataType(DateTime, ErrorMessage = "invlid champs")]
        ...
        [Key]
        [MaxLength(7,ErrorMessage ="Max lengh 7"),MinLength(7,ErrorMessage ="Min lengh 7")]
        public string EmailAddress { get; set; }
        [EmailAddress(ErrorMessage ="email type")]
        // [DataType(DataType.EmailAddress, ErrorMessage = "Error message.")]

        public string FirstName { get; set; }
        [MaxLength (25,ErrorMessage ="max lengh is 25"),MinLength(3,ErrorMessage ="Min lengh is 3")]
        public string LastName { get; set; }
        public string TelNumber { get; set; }
        [Phone( ErrorMessage ="invalide tel")]
